...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.userDo.UseModel(&userData.User{})
...
func (u userDo) Create(values ...*userData.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) CreateInBatches(values []*userData.User, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userDo) Save(values ...*userData.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) First() (*userData.User, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*userData.User), nil
	}
}

func (u userDo) Take() (*userData.User, error) {
...
func (u userDo) Last() (*userData.User, error) {
...
func (u userDo) Find() ([]*userData.User, error) {
	result, err := u.DO.Find()
	return result.([]*userData.User), err
}

func (u userDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*userData.User, err error) {
	buf := make([]*userData.User, 0, batchSize)
...
func (u userDo) FindInBatches(result *[]*userData.User, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userDo) FirstOrInit() (*userData.User, error) {
...
func (u userDo) FirstOrCreate() (*userData.User, error) {
...
func (u userDo) FindByPage(offset int, limit int) (result []*userData.User, count int64, err error) {
...
func (u userDo) Delete(models ...*userData.User) (result gen.ResultInfo, err error) {
