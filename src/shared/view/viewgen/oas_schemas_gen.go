...
// UserJokesDelNoContent is response for UserJokesDel operation.
type UserJokesDelNoContent struct{}

type UserJokesDelReq struct {
	JokeID string `json:"joke_id"`
}

// GetJokeID returns the value of JokeID.
func (s *UserJokesDelReq) GetJokeID() string {
	return s.JokeID
}

// SetJokeID sets the value of JokeID.
func (s *UserJokesDelReq) SetJokeID(val string) {
	s.JokeID = val
}

type UserJokesPostReq struct {
	Title       string    `json:"title"`
	Text        string    `json:"text"`
	Explanation OptString `json:"explanation"`
}
...
// GetTitle returns the value of Title.
func (s *UserJokesPostReq) GetTitle() string {
	return s.Title
}

// GetText returns the value of Text.
func (s *UserJokesPostReq) GetText() string {
	return s.Text
}

// GetExplanation returns the value of Explanation.
func (s *UserJokesPostReq) GetExplanation() OptString {
	return s.Explanation
}

// SetTitle sets the value of Title.
func (s *UserJokesPostReq) SetTitle(val string) {
	s.Title = val
}

// SetText sets the value of Text.
func (s *UserJokesPostReq) SetText(val string) {
	s.Text = val
}

// SetExplanation sets the value of Explanation.
func (s *UserJokesPostReq) SetExplanation(val OptString) {
	s.Explanation = val
}

type UserJokesPutReq struct {
...
// GetJokeID returns the value of JokeID.
func (s *UserJokesPutReq) GetJokeID() string {
	return s.JokeID
}

// GetTitle returns the value of Title.
func (s *UserJokesPutReq) GetTitle() OptString {
	return s.Title
}

// GetText returns the value of Text.
func (s *UserJokesPutReq) GetText() OptString {
	return s.Text
}

// GetExplanation returns the value of Explanation.
func (s *UserJokesPutReq) GetExplanation() OptString {
	return s.Explanation
}

// SetJokeID sets the value of JokeID.
func (s *UserJokesPutReq) SetJokeID(val string) {
	s.JokeID = val
}

// SetTitle sets the value of Title.
func (s *UserJokesPutReq) SetTitle(val OptString) {
	s.Title = val
}

// SetText sets the value of Text.
func (s *UserJokesPutReq) SetText(val OptString) {
	s.Text = val
}

// SetExplanation sets the value of Explanation.
func (s *UserJokesPutReq) SetExplanation(val OptString) {
	s.Explanation = val
}
