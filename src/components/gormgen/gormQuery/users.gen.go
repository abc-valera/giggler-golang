...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.userDo.UseModel(&gormModel.User{})
...
func (u userDo) Create(values ...*gormModel.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) CreateInBatches(values []*gormModel.User, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userDo) Save(values ...*gormModel.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) First() (*gormModel.User, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*gormModel.User), nil
	}
}

func (u userDo) Take() (*gormModel.User, error) {
...
func (u userDo) Last() (*gormModel.User, error) {
...
func (u userDo) Find() ([]*gormModel.User, error) {
	result, err := u.DO.Find()
	return result.([]*gormModel.User), err
}

func (u userDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gormModel.User, err error) {
	buf := make([]*gormModel.User, 0, batchSize)
...
func (u userDo) FindInBatches(result *[]*gormModel.User, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userDo) FirstOrInit() (*gormModel.User, error) {
...
func (u userDo) FirstOrCreate() (*gormModel.User, error) {
...
func (u userDo) FindByPage(offset int, limit int) (result []*gormModel.User, count int64, err error) {
...
func (u userDo) Delete(models ...*gormModel.User) (result gen.ResultInfo, err error) {
